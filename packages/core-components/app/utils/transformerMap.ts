export const propertyToTransformer = {
  ...
  family: async () => (await import("./transform/typography/family")).default,
  ...
  columnCount: async () => (await import("./transform/column/columnCount")).default,
  columnFill: async () => (await import("./transform/column/columnFill")).default,
  columnRuleColor: async () => (await import("./transform/column/columnRuleColor")).default,
  columnRuleStyle: async () => (await import("./transform/column/columnRuleStyle")).default,
  columnRuleWidth: async () => (await import("./transform/column/columnRuleWidth")).default,
  columnSpan: async () => (await import("./transform/column/columnSpan")).default,
};
