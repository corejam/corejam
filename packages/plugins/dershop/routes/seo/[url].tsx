...
export class UrlRoute {
  ...
  async componentWillLoad() {
    ...
    this._data = (await coreState.client.request(getObjectFromURL, {
      url: this._param.url,
    })).objectFromURL;
  ...
  getComponentForRoute() {
    if ((this._object = this._data.product))
      return <dershop-product product={this._object}></dershop-product>;
