...
declare module "@stencil/core" {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      "auth-reset-password-form": LocalJSX.AuthResetPasswordForm &
        JSXBase.HTMLAttributes<HTMLAuthResetPasswordFormElement>;
      ...
      "corejam-auth-route-account": LocalJSX.CorejamAuthRouteAccount &
        JSXBase.HTMLAttributes<HTMLCorejamAuthRouteAccountElement>;
      "corejam-auth-route-reset": LocalJSX.CorejamAuthRouteReset &
        JSXBase.HTMLAttributes<HTMLCorejamAuthRouteResetElement>;
      "corejam-auth-route-verify": LocalJSX.CorejamAuthRouteVerify &
        JSXBase.HTMLAttributes<HTMLCorejamAuthRouteVerifyElement>;
